...
export default function IncNum() {
  ...
  return (
    <div>
        ...
        <Button variant='contained' color='error' onClick={handleUpClick}>Clic me</Button>
        <Button variant='contained' color='secondary' onClick={showNumber}>Click for Show Number</Button>
